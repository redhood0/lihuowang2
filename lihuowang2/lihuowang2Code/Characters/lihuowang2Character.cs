    ...
    lihuowang2Character : ModCharacterTemplate<lihuowang2CardPool, lihuowang2RelicPool, lihuowang2PotionPool>
{
    ...
    private const string CharacterScenePath = $"{SceneRoot}/lihuowang2_character.tscn";
    private const string EnergyCounterScenePath = $"{SceneRoot}/lihuowang2_energy_counter.tscn";
    private const string MerchantScenePath = $"{SceneRoot}/lihuowang2_merchant.tscn";
    private const string RestSiteScenePath = $"{SceneRoot}/lihuowang2_rest_site.tscn";
    private const string CharacterSelectBgScenePath = $"{SceneRoot}/lihuowang2_character_select_bg.tscn";
    ...
    public override CharacterAssetProfile AssetProfile => new(
        ...
        Ui: new CharacterUiAssetSet(
            ...
            // 人物选择图标。
            CharacterSelectIconPath: $"{ImageRoot}/lihuowang2_character_select.png",
            // 人物选择图标-锁定状态。
            CharacterSelectLockedIconPath: $"{ImageRoot}/lihuowang2_character_select_locked.png",
            // 地图上的角色标记图标、表情轮盘上的角色头像。
            MapMarkerPath: $"{ImageRoot}/lihuowang2_map_marker.png"));
